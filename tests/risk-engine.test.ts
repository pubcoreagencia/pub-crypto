...
const market: MarketSnapshot = {
  snapshotId: 'm1', symbol: 'BTCUSDT', asOf: 1_000, price: 100_000,
  source: 'fixture', candles: []
};

const portfolio: PortfolioState = {
  equity: 100_000, availableCapital: 100_000, grossExposure: 0,
  positions: {}, dailyPnl: 0, rollingDrawdownPct: 0, killSwitch: false
};

const proposal: TradeProposal = {
  proposalId: 'p1', symbol: 'BTCUSDT', side: 'LONG', entry: 100_000, stop: 95_000,
  target: 110_000, requestedQuantity: 0.05, horizonMinutes: 240,
  strategyVersion: 'fixture-v1', thesis: 'fixture', researchRunId: 'r1', snapshotId: 'm1'
};
