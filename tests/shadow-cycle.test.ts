...
const riskConfig: RiskConfig = { maxPortfolioExposurePct: 30, maxSingleAssetExposurePct: 10, maxStrategyExposurePct: 10, maxLeverage: 1, maxDrawdownPct: 15, maxSlippagePct: 1 };
